...
ALTER TABLE t_sgv_nota
    ADD CONSTRAINT t_sgv_nota_t_sgv_venda_fk FOREIGN KEY ( t_sgv_venda_cd_venda )
...
ALTER TABLE t_sgv_venda
    ADD CONSTRAINT t_sgv_venda_t_sgv_nota_fk FOREIGN KEY ( t_sgv_nota_cd_nota )
        REFERENCES t_sgv_nota ( cd_nota );
